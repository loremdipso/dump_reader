...
var app = (function () {
    ...
    /* src/common/GithubCorner.svelte generated by Svelte v3.48.0 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link0, file, 10, 1, 289);
    			attr_dev(link1, "rel", "stylesheet");
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css?family=Roboto:300,400,500,600,700");
    			add_location(link1, file, 15, 1, 401);
    			attr_dev(link2, "rel", "stylesheet");
    			attr_dev(link2, "href", "https://fonts.googleapis.com/css?family=Roboto+Mono");
    			add_location(link2, file, 20, 1, 529);
    			attr_dev(a, "href", ".");
    			attr_dev(a, "class", "text-white");
    			add_location(a, file, 31, 3, 885);
    			attr_dev(h6, "class", "select-none pl-3 tracking-widest text-lg");
    			add_location(h6, file, 30, 2, 828);
    			attr_dev(header, "class", "relative slide-in-from-top bg-primary-300 dark:bg-black flex flex-wrap h-16 items-center justify-center left-0 p-0 shadow top-0 w-full z-20 svelte-kax99i");
    			add_location(header, file, 27, 1, 665);
    			attr_dev(main, "class", "pb-32 fade-in svelte-kax99i");
    			add_location(main, file, 26, 0, 635);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, GithubCorner });
    	return [];
    }
